...
require (
	...
	github.com/go-pnp/go-pnp/watermill/pnpwatermill v0.1.0
	...
	github.com/saturn4er/boilerplate-go v1.6.0
...
require (
	...
	github.com/ThreeDotsLabs/watermill-sql/v4 v4.1.3 // indirect
